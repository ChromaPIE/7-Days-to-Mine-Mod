...
public class ItemSleepingBag extends Item implements IItemVariant
{
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            if (player.canPlayerEdit(pos, facing, itemstack) && player.canPlayerEdit(blockpos, facing, itemstack))
            {
                ...
                {
                    IBlockState iblockstate2 = ModBlocks.SLEEPING_BAG.getDefaultState().withProperty(BlockSleepingBag.OCCUPIED, Boolean.valueOf(false)).withProperty(BlockSleepingBag.FACING, enumfacing).withProperty(BlockSleepingBag.PART, BlockSleepingBag.EnumPartType.FOOT);
                    ...
                    {
                        ((TileEntitySleepingBag)tileentity).setItemValues(itemstack);
                    }
                    ...
                    {
                        ((TileEntitySleepingBag)tileentity1).setItemValues(itemstack);
                    }
