...
public class ItemCorn extends ItemFood implements net.minecraftforge.common.IPlantable {
	public ItemCorn() {
		super(1, 1f, false);
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand,
		...
		if (facing == EnumFacing.UP && player.canPlayerEdit(pos.offset(facing), facing, itemstack)
			...
			worldIn.setBlockState(pos.up(), ModBlocks.CORN_PLANT.getDefaultState());
