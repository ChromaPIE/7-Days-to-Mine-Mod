...
public class EntityShot extends Entity implements IProjectile {
	...
	public EntityShot(World worldIn, EntityLivingBase shooter) {
		this(worldIn, shooter.posX, shooter.posY + (double) shooter.getEyeHeight() - 0.10000000149011612D,
				shooter.posZ);
		this.shootingEntity = shooter;
	}

	public EntityShot(World worldIn, Vec3d start, float yaw, float pitch, float velocity, float spread) {
	...
	public EntityShot(World worldIn, EntityLivingBase shooter, float velocity, float spread) {
		this(worldIn, shooter.posX, shooter.posY + (double) shooter.getEyeHeight() - 0.10000000149011612D,
				shooter.posZ);
		this.shootingEntity = shooter;
