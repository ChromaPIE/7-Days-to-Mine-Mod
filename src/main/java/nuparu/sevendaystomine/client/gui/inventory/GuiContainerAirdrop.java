...
public class GuiContainerAirdrop extends GuiContainer {

	private static final ResourceLocation resourceLocation = new ResourceLocation("textures/gui/container/dispenser.png");
	protected InventoryPlayer playerInventory;
	protected EntityAirdrop entity;

	public GuiContainerAirdrop(InventoryPlayer playerInventory, EntityAirdrop entity,
			Container container) {
		super(container);
