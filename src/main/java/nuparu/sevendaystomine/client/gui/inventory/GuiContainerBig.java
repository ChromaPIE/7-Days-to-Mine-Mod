...
public class GuiContainerBig extends GuiContainer {

	private static final ResourceLocation resourceLocation = new ResourceLocation(SevenDaysToMine.MODID,
			"textures/gui/container/container_big.png");
	InventoryPlayer playerInventory;
	TileEntity tileEntity;

	public GuiContainerBig(InventoryPlayer playerInventory, IInventory tileEntity, Container container) {
		super(container);
