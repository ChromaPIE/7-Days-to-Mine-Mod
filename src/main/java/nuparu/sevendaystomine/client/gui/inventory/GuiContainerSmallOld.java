...
public class GuiContainerSmallOld extends GuiContainer {
	...
	public GuiContainerSmallOld(InventoryPlayer playerInventory, IInventory tileEntity, Container container) {
		super(container);
