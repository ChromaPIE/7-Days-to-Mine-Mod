...
public class GuiWorkbenchUncrafting extends GuiContainer {
	...
	public GuiWorkbenchUncrafting(InventoryPlayer playerInventory, Container container) {
		super(container);
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		RenderUtils.drawCenteredString(s, 40, 6, 4210752);
