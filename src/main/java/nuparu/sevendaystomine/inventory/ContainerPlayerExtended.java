...
public class ContainerPlayerExtended extends ContainerPlayer {
	public ContainerPlayerExtended(InventoryPlayer inventoryPlayer, boolean localWorld, EntityPlayer playerIn)
    {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if(slot != null && slot.getHasStack())
        {
            ...
            if(index != 46 && copy.getItem() instanceof ItemBackpack)
            {
