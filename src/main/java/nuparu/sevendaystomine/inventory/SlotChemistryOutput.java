...
public class SlotChemistryOutput extends SlotItemHandler
{
    ...
    protected void onCrafting(ItemStack stack)
    {
        ...
        if (!this.player.world.isRemote && inventory instanceof TileEntityChemistryStation)
        {
        	TileEntityChemistryStation tileEntity = (TileEntityChemistryStation)inventory;
