...
public class SlotCampfireOutput extends SlotItemHandler {
	/** The player that is using the GUI where this slot resides. */
	private final EntityPlayer player;
	private int removeCount;

	public SlotCampfireOutput(EntityPlayer player, IItemHandler inventoryIn, int slotIndex, int xPosition,
			int yPosition) {
