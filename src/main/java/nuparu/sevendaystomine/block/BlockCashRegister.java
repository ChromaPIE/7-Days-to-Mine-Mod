...
public class BlockCashRegister extends BlockTileProvider<TileEntityCashRegister> implements IScrapable {
	...
	@Override
	public TileEntityCashRegister createTileEntity(World world, IBlockState state) {
		return new TileEntityCashRegister();
	}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
		...
		if (stack.hasDisplayName()) {
			...
			if (tileentity instanceof TileEntityCashRegister) {
				((TileEntityCashRegister) tileentity).setDisplayName(stack.getDisplayName());
			}
		}
	}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		if (!worldIn.isRemote) {
			TileEntity te = worldIn.getTileEntity(pos);
			if (te instanceof TileEntityCashRegister) {
				NonNullList<ItemStack> drops = ((TileEntityCashRegister) te).getDrops();
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		...
		final TileEntityCashRegister tileEntity = getTileEntity(world, pos);
		if (tileEntity != null) {
