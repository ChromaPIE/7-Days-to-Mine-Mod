...
public class BlockChestOld extends BlockTileProvider<TileEntityOldChest> {

	public static final PropertyDirection FACING = BlockHorizontalBase.FACING;
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            {
                ((TileEntityOldChest)tileentity).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public ILockableContainer getContainer(World worldIn, BlockPos pos, boolean allowBlocking)
    {
        ...
        {
            ILockableContainer ilockablecontainer = (TileEntityOldChest)tileentity;
            ...
            else
            {
                for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL)
                {
                    ...
                    if (block == this)
                    {
                        ...
                        if (tileentity1 instanceof TileEntityOldChest)
                        {
                            if (enumfacing != EnumFacing.WEST && enumfacing != EnumFacing.NORTH)
                            {
                                ilockablecontainer = new InventoryLargeChest("container.chestDouble", ilockablecontainer, (TileEntityOldChest)tileentity1);
                            }
                            else
                            {
                                ilockablecontainer = new InventoryLargeChest("container.chestDouble", (TileEntityOldChest)tileentity1, ilockablecontainer);
                            }
                        }
                    }
                }
    ...
    public int getWeakPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityOldChest)
            {
                i = ((TileEntityOldChest)tileentity).numPlayersUsing;
            }
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityOldChest();
	}
	@Override
	public TileEntityOldChest createTileEntity(World world, IBlockState state) {
		return new TileEntityOldChest();
	}
