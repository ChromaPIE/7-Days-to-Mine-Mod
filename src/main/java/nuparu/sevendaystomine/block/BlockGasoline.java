...
public class BlockGasoline extends BlockFluidFinite implements IBlockBase {
	...
	public IStateMapper getStateMapper() {
		return new StateMapperBase() {
			...
			protected ModelResourceLocation getModelResourceLocation(IBlockState state) {
				return new ModelResourceLocation(SevenDaysToMine.MODID + ":fluids", "gasoline");
			}
		};
