...
public class BlockChemistryStation extends BlockTileProvider<TileEntityChemistryStation> {
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityChemistryStation();
	}

	@Override
	public TileEntityChemistryStation createTileEntity(World world, IBlockState state) {
		return new TileEntityChemistryStation();
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (worldIn.isRemote) {
			...
			playerIn.openGui(SevenDaysToMine.instance, 12, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
