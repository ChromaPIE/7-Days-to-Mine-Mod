...
public class WastelandGenLayerHills extends GenLayer
{
    private static final Logger LOGGER = LogManager.getLogger();
    private final GenLayer riverLayer;

    public WastelandGenLayerHills(long p_i45479_1_, GenLayer p_i45479_3_, GenLayer p_i45479_4_)
    {
        super(p_i45479_1_);
        ...
        for (int i = 0; i < areaHeight; ++i)
        {
            for (int j = 0; j < areaWidth; ++j)
            {
                ...
                else
                {
                    ...
                    {
                        biome1 = ModBiomes.WASTELAND_DEEP_OCEAN;
                    }
                    ...
                    else if (biome == ModBiomes.WASTELAND_DEEP_OCEAN && this.nextInt(3) == 0)
                    {
                        int i1 = this.nextInt(2);

                        if (i1 == 0)
                        {
                            biome1 = ModBiomes.WASTELAND;
                        }
                        else
                        {
                            biome1 = ModBiomes.BURNT_FOREST;
                        }
                    }
