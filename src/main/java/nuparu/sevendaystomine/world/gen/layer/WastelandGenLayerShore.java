...
public class WastelandGenLayerShore extends GenLayer
{
    public WastelandGenLayerShore(long p_i2130_1_, GenLayer p_i2130_3_)
    {
        super(p_i2130_1_);
        ...
        for (int i = 0; i < areaHeight; ++i)
        {
            for (int j = 0; j < areaWidth; ++j)
            {
                ...
                if (k == Biome.getIdForBiome(Biomes.MUSHROOM_ISLAND))
                {
                    ...
                    if (j2 != Biome.getIdForBiome(ModBiomes.WASTELAND_OCEAN) && i3 != Biome.getIdForBiome(ModBiomes.WASTELAND_OCEAN) && l3 != Biome.getIdForBiome(ModBiomes.WASTELAND_OCEAN) && k4 != Biome.getIdForBiome(ModBiomes.WASTELAND_OCEAN))
                    {
                ...
                else if (biome != null && BiomeDictionary.hasType(biome, BiomeDictionary.Type.JUNGLE))
                {
                    ...
                    if (this.isJungleCompatible(i2) && this.isJungleCompatible(l2) && this.isJungleCompatible(k3) && this.isJungleCompatible(j4))
                    {
                        ...
                        {
                            aint1[j + i * areaWidth] = Biome.getIdForBiome(ModBiomes.WASTELAND_BEACH);
                        }
                    }
                    else
                    {
                ...
                else if (k != Biome.getIdForBiome(Biomes.EXTREME_HILLS) && k != Biome.getIdForBiome(Biomes.EXTREME_HILLS_WITH_TREES) && k != Biome.getIdForBiome(Biomes.EXTREME_HILLS_EDGE))
                {
                    ...
                    {
                        if (k != Biome.getIdForBiome(ModBiomes.WASTELAND_OCEAN) && k != Biome.getIdForBiome(ModBiomes.WASTELAND_DEEP_OCEAN) && k != Biome.getIdForBiome(ModBiomes.WASTELAND_RIVER) && k != Biome.getIdForBiome(Biomes.SWAMPLAND))
                        {
                    ...
                    else
                    {
                        ...
                        if (!isBiomeOceanic(l) && !isBiomeOceanic(i1) && !isBiomeOceanic(j1) && !isBiomeOceanic(k1))
                        {
                            ...
                            {
                                aint1[j + i * areaWidth] = Biome.getIdForBiome(ModBiomes.WASTELAND_DESERT);
                            }
                        }
                        else
                        {
    ...
    private boolean isJungleCompatible(int p_151631_1_)
    {
        ...
        {
            return p_151631_1_ == Biome.getIdForBiome(Biomes.JUNGLE_EDGE) || p_151631_1_ == Biome.getIdForBiome(Biomes.JUNGLE) || p_151631_1_ == Biome.getIdForBiome(Biomes.JUNGLE_HILLS) || p_151631_1_ == Biome.getIdForBiome(ModBiomes.BURNT_FOREST) || p_151631_1_ == Biome.getIdForBiome(ModBiomes.BURNT_TAIGA) || isBiomeOceanic(p_151631_1_);
        }
    }
